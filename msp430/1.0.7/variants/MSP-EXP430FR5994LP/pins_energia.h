...
static const uint8_t AUX_UART2RXD = 34;     /* Receive  Data (RXD) at P2.6 */
static const uint8_t AUX_UART2TXD = 35;     /* Transmit Data (TXD) at P2.5 */
...
#define AUX_UART2RXD_SET_MODE (PORT_SELECTION1 | INPUT)
#define AUX_UART2TXD_SET_MODE (PORT_SELECTION1 | OUTPUT)
#define DEBUG_UART_MODULE_OFFSET 0x00
#define AUX_UART_MODULE_OFFSET 0x60
#define AUX_UART2_MODULE_OFFSET 0x20
#define SERIAL1_AVAILABLE 1
#define SERIAL2_AVAILABLE 1
#endif
